...
use crate::identities::{RunningVms, Uuid, Hosts, Vms};
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(RunningVms::Host).custom(Uuid::Uuid).not_null())
                    .col(ColumnDef::new(RunningVms::IsOrphan).boolean().not_null())
                    .col(ColumnDef::new(RunningVms::VmUuid).custom(Uuid::Uuid).not_null())
